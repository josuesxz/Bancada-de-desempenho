...
while True:
    ...
    path = "C:/Users/stem/GuitHub/Bancada-de-desempenho/Automação de dados/Registros/M3_Reteste_M2/" + nomeArquivo #definido endereço para o arquivo (mudar conforme o local que deseja)
