...
while True:
    ...
    path = "C:/Users/Iatecam/Desktop/Bancada-de-desempenho/Automação de dados/Registros/M1/" + nomeArquivo #definido endereço para o arquivo (mudar conforme o local que deseja)
